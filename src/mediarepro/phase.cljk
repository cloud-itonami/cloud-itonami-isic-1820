(ns mediarepro.phase
  "Phase 0->3 staged rollout for the media-reproduction plant-
  ...
  consequence (a duplication-line-equipment maintenance window means
  production downtime, and the equipment ends up actually touched); it
  is always a human plant supervisor's call.
  `mediarepro.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Media Reproduction Plant Operations Governor verdict to a
  base disposition before the phase gate."
  [verdict]
