# Operator Quickstart — Reproduction of recorded media

Shortest path from clone to a verified local dry-run for **ISIC 1820** (`cloud-itonami-isic-1820`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1820.git
cd cloud-itonami-isic-1820
```
...
- Blueprint governor key: `media-reproduction-plant-operations-governor`
- Likely source path: `mediarepro.governor.cljc`
