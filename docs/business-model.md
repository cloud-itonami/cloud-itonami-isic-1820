# Business Model: Reproduction of recorded media
...
## Classification
- Repository: `cloud-itonami-isic-1820` ([github.com/cloud-itonami/cloud-itonami-isic-1820](https://github.com/cloud-itonami/cloud-itonami-isic-1820))
- ISIC Rev.5: `1820` — Reproduction of recorded media
- Domain: `:media-reproduction/duplication`
- Social impact: :worker-safety :product-quality :copyright-integrity
- Actor: `:media-reproduction-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :media-reproduction/duplication — who wants
...
One managed tenant (:media-reproduction/duplication):
...
- Do not bypass the `:media-reproduction-plant-operations-governor` for production decisions.
